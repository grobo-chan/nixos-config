...
- [Vimjoyer's Impermanence guide](https://www.youtube.com/watch?v=ZKBSWS7OOb4)
  ...
  NOTE: The above uses a tmpfs root while this config uses a btrfs root subvolume which is nuked on boot via a bootscript

- [Goxore's Nixconf](https://github.com/goxore/nixconf)
- [Iynaix's Dotfiles](https://github.com/iynaix/dotfiles)
- [Coca's quickstart on NPins](https://coca.codes/npins-nixos/)
- [Tipson's guide on Flakes to NPins](https://tipson.xyz/posts/npins/#npins-instead-of-flakes)
